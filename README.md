...
**If you need any more modes in repo or If you find out any bugs, mention IMMORTAL king ](https://www.telegram.i)**
...
#### Deploy on Heroku
**IMMORTAL KING<br>
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Mohammedshamkl/File-Sharing-Bot)</br>
...
* `CUSTOM_CAPTION` put your Custom caption text if you want Setup Custom Caption, you can use HTML and <a href='https://github.com//File-Sharing-Bot/blob/main/README.md#custom_caption'>fillings</a> for formatting (only for documents)
